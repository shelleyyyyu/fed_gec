...
python -m experiments.distributed.transformer_exps.obsolete.main_text_classification \
...
```bash
LOG_FILE="experiments/distributed/transformer_exps/obsolete/fedavg_transformer_qa.log"
CLIENT_NUM=100
WORKER_NUM=10
SERVER_NUM=1
GPU_NUM_PER_SERVER=4
...
mpirun -np $PROCESS_NUM -hostfile $HOST_FILE \
python -m experiments.distributed.transformer_exps.obsolete.main_question_answering \
    --gpu_mapping_file "experiments/distributed/transformer_exps/gpu_mapping.yaml" \
    --gpu_mapping_key mapping_ink-ron \
    --client_num_in_total $CLIENT_NUM \
    --client_num_per_round $WORKER_NUM \
